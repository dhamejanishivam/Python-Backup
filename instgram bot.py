...
manu_dm = browser.find_element_by_xpath("/html/body/div[1]/section/div/div[2]/div/div/div[1]/div[2]/div/div/div/div/div[1]/a/div")
...
while(i<=900):
    ...
    message_button.send_keys(f"This is {abc} message , Total message left to be recived are {900-abc}")
